...
int main(int argc, char *argv[]){
    ...
    if(-1==GPIOUnexport(POUT_R_TRIG)||-1== GPIOUnexport(PIN_R_ECHO)||-1== GPIOUnexport(PIN_L_ECHO)){
        return -1;
    }
    
    if(-1==GPIOExport(POUT_R_TRIG)||-1==GPIOExport(PIN_R_ECHO)||-1==GPIOExport(PIN_L_ECHO)){
    ...
    if(-1==GPIODirection(POUT_R_TRIG,OUT) ||-1==GPIODirection(PIN_R_ECHO,IN) ||-1==GPIODirection(PIN_L_ECHO,IN)){
